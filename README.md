...
- **Summarization experiments** — a benchmark of five summarization methods (TextRank, LexRank,
  BART, PEGASUS, PRIMERA) on the curated corpus, via the
  [pyAutoSummarizer](https://github.com/Valdecy/pyAutoSummarizer) library (PRIMERA directly via
  `transformers`, scored with the same metrics): one notebook per
...
| [notebooks/](notebooks/) | Summarization benchmark notebooks (TextRank, LexRank, BART, PEGASUS, PRIMERA + comparison), in Italian — see [notebooks/README.md](notebooks/README.md) |
